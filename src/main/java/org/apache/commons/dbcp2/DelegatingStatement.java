 ...
 * 
 * @param <S> Statement or a sub-type.
 *
 * @since 2.0
 */
public class DelegatingStatement<S extends Statement> extends AbandonedTrace implements Statement {
    ...
    public S getInnermostDelegate() {
        ...
        while (s instanceof DelegatingStatement) {
            s = ((DelegatingStatement<S>) s).getDelegate();
            if (this == s) {
                return null;
            }
        }
