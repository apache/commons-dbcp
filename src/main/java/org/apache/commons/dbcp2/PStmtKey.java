...
public class PStmtKey {
    ...
    public PStmtKey(String sql) {
        this(sql, null, PoolingConnection.STATEMENT_PREPAREDSTMT, null);
    }

    public PStmtKey(String sql, String catalog) {
        this(sql, catalog, PoolingConnection.STATEMENT_PREPAREDSTMT, null);
    }

    public PStmtKey(String sql, String catalog, int autoGeneratedKeys) {
        this(sql, catalog, PoolingConnection.STATEMENT_PREPAREDSTMT, Integer.valueOf(autoGeneratedKeys));
    }

    public PStmtKey(String sql, String catalog, byte stmtType, Integer autoGeneratedKeys) {
        _sql = sql;
        _catalog = catalog;
        _stmtType = stmtType;
