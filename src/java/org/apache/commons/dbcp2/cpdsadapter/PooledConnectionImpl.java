...
class PooledConnectionImpl implements PooledConnection,
    ...
    // TODO - make final?
    protected KeyedObjectPool<PStmtKey,PoolablePreparedStatementStub> pstmtPool = null;
    ...
    public void setStatementPool(
            KeyedObjectPool<PStmtKey,PoolablePreparedStatementStub> statementPool) {
     ...
     */
    @Override
    public PoolablePreparedStatementStub makeObject(PStmtKey key) throws Exception {
        if (null == key) {
     ...
     */
    @Override
    public boolean validateObject(PStmtKey key, PoolablePreparedStatementStub ppss) {
        return true;
    }
     ...
     */
    @Override
    public void activateObject(PStmtKey key, PoolablePreparedStatementStub ppss)
            throws Exception {
        ppss.activate();
    }
     ...
     */
    @Override
    public void passivateObject(PStmtKey key, PoolablePreparedStatementStub ppss)
            throws Exception {
