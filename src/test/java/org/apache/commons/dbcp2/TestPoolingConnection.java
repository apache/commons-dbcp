...
public class TestPoolingConnection {
    ...
    public void testPrepareStatement() throws Exception {
        ...
        DelegatingPreparedStatement statement = (DelegatingPreparedStatement)con.prepareStatement(sql);
    ...
    public void testPrepareStatementWithAutoGeneratedKeys() throws Exception {
        ...
        DelegatingPreparedStatement statement = (DelegatingPreparedStatement)con.prepareStatement(sql, autoGeneratedKeys);
        TesterPreparedStatement testStatement = (TesterPreparedStatement) statement.getInnermostDelegate();
        // assert
        assertEquals(sql, testStatement.getSql());
    ...
    public void testPrepareStatementWithResultSetConcurrency() throws Exception {
        ...
        DelegatingPreparedStatement statement = (DelegatingPreparedStatement)con.prepareStatement(sql, resultSetType, resultSetConcurrency);
        TesterPreparedStatement testStatement = (TesterPreparedStatement) statement.getInnermostDelegate();
        // assert
        assertEquals(sql, testStatement.getSql());
    ...
    public void testPrepareCallWithResultSetConcurrency() throws Exception {
        ...
        int resultSetType = 0;
        int resultSetConcurrency = 0;
        DelegatingCallableStatement statement = (DelegatingCallableStatement)con.prepareCall(sql, resultSetType, resultSetConcurrency);
        TesterCallableStatement testStatement = (TesterCallableStatement) statement.getInnermostDelegate();
        // assert
        assertEquals(sql, testStatement.getSql());
        assertEquals(resultSetType, testStatement.getResultSetType());
