...
public class TestSynchronizationOrder {
    ...
    public void testSessionSynchronization() throws Exception {
        DataSourceXAConnectionFactory xaConnectionFactory = new DataSourceXAConnectionFactory(transactionManager, xads);
        ...
        ManagedDataSource ds = new ManagedDataSource<>(pool, xaConnectionFactory.getTransactionRegistry());
    ...
    public void testInterposedSynchronization() throws Exception {
        DataSourceXAConnectionFactory xaConnectionFactory = new DataSourceXAConnectionFactory(transactionManager, xads, transactionSynchronizationRegistry);
